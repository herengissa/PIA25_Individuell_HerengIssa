...
-- 5. Produkter med varumärkesnamn
SELECT p.id, p.name AS product_name, p.category, b.name AS brand_name, b.country
FROM products p
JOIN brands b ON b.id = p.brand_id
ORDER BY brand_name, product_name;

-- 6. Beställningar med kundnamn
...
-- 7. Vilka produkter varje kund köpt
...
-- 8. Antal produkter per varumärke
